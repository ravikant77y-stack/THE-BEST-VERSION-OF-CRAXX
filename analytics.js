const CRAXX_PRODUCTS = {
  "Choco Rings": { category: "savouries", price: 75, cost: 48, weight: "18gm", sku: "CRX-CHO-RNG", reorderLevel: 12, image: "https://i.ibb.co/PG05yWJg/choco-rings.jpg" },
  "Tangy Tomato Rings": { category: "savouries", price: 75, cost: 48, weight: "24gm", sku: "CRX-TOM-RNG", reorderLevel: 12, image: "https://i.ibb.co/mCYPyQtc/tangy-tomato-rings.jpg" },
  "Masala Rings": { category: "savouries", price: 75, cost: 48, weight: "24gm", sku: "CRX-MAS-RNG", reorderLevel: 12, image: "https://i.ibb.co/WN6MLXy1/masala-rings.jpg" },
  "Masala Curls": { category: "savouries", price: 75, cost: 48, weight: "33gm", sku: "CRX-MAS-CUR", reorderLevel: 12, image: "https://i.ibb.co/XfshrwFP/masala-curls.jpg" },
  "Cheese Curls": { category: "savouries", price: 75, cost: 48, weight: "33gm", sku: "CRX-CHS-CUR", reorderLevel: 12, image: "https://i.ibb.co/SZXxXYG/cheese-curls.jpg" },
  "Fritts Cream Onion": { category: "savouries", price: 75, cost: 48, weight: "33gm", sku: "CRX-FRT-CON", reorderLevel: 12, image: "https://i.ibb.co/PG9xgdX2/fritts-cream-onion.jpg" },
  "Fritts Peri Peri": { category: "savouries", price: 75, cost: 48, weight: "33gm", sku: "CRX-FRT-PPP", reorderLevel: 12, image: "https://i.ibb.co/VY8X64ZF/fritts-peri-peri.jpg" },
  "Masala Natkhat": { category: "savouries", price: 75, cost: 48, weight: "33gm", sku: "CRX-MAS-NAT", reorderLevel: 12, image: "https://i.ibb.co/dsSQ0x4L/masala-natkhat.jpg" },
  "Biggies": { category: "savouries", price: 75, cost: 48, weight: "24gm", sku: "CRX-BIG", reorderLevel: 12, image: "https://i.ibb.co/KcjbWzyj/biggies.jpg" },
  "Pipes": { category: "savouries", price: 60, cost: 38, weight: "20gm", sku: "CRX-PIP", reorderLevel: 12, image: "https://i.ibb.co/hxqH0PdN/pipes.jpg" },
  "Cheese Ball": { category: "savouries", price: 75, cost: 48, weight: "33gm", sku: "CRX-CHS-BAL", reorderLevel: 12, image: "https://i.ibb.co/C3Cf6Lfx/cheese-ball.jpg" },
  "Noodles": { category: "savouries", price: 60, cost: 38, weight: "34gm", sku: "CRX-NOD", reorderLevel: 12, image: "https://i.ibb.co/QFMRNrMk/noodles.jpg" },
  "Salted Chips": { category: "chips", price: 75, cost: 48, weight: "26gm", sku: "CRX-SAL-CHP", reorderLevel: 12, image: "https://i.ibb.co/wFnSsQ6X/salted-chips.jpg" },
  "Cream Onion Chips": { category: "chips", price: 75, cost: 48, weight: "26gm", sku: "CRX-CON-CHP", reorderLevel: 12, image: "https://i.ibb.co/XnRrqC3/cream-onion-chips.jpg" },
  "Tomato Chips": { category: "chips", price: 75, cost: 48, weight: "26gm", sku: "CRX-TOM-CHP", reorderLevel: 12, image: "https://i.ibb.co/93cMXd7J/tomato-chips.jpg" },
  "Masala Chips": { category: "chips", price: 75, cost: 48, weight: "26gm", sku: "CRX-MAS-CHP", reorderLevel: 12, image: "https://i.ibb.co/0y5jkspm/masala-chips.jpg" },
  "Double Mazza": { category: "namkeen", price: 75, cost: 48, weight: "31gm", sku: "CRX-DBL-MAZ", reorderLevel: 12, image: "https://i.ibb.co/hxWtsMT7/double-mazza.jpg" },
  "Hara Mutter": { category: "namkeen", price: 75, cost: 48, weight: "31gm", sku: "CRX-HAR-MUT", reorderLevel: 12, image: "https://i.ibb.co/Cs4YRs43/hara-mutter.jpg" },
  "Aloo Bhujia": { category: "namkeen", price: 75, cost: 48, weight: "41gm", sku: "CRX-ALO-BHU", reorderLevel: 12, image: "https://i.ibb.co/r2Z63jHj/aloo-bhujia.jpg" },
  "Moong Dal": { category: "namkeen", price: 75, cost: 48, weight: "38gm", sku: "CRX-MOO-DAL", reorderLevel: 12, image: "https://i.ibb.co/5xv5gXXK/moong-dal.jpg" },
  "Bikaneri Bhujia": { category: "namkeen", price: 75, cost: 48, weight: "35gm", sku: "CRX-BIK-BHU", reorderLevel: 12, image: "https://i.ibb.co/mVkKCd8g/bikaneri-bhujia.jpg" },
  "Khatta Meetha": { category: "namkeen", price: 75, cost: 48, weight: "41gm", sku: "CRX-KHA-MEE", reorderLevel: 12, image: "https://i.ibb.co/YBrBBxVS/khatta-meetha.jpg" },
  "Navratan Mixture": { category: "namkeen", price: 75, cost: 48, weight: "43gm", sku: "CRX-NAV-MIX", reorderLevel: 12, image: "https://i.ibb.co/6JwQ2S0c/navratan-mixture.jpg" },
  "Mast Moongfali": { category: "namkeen", price: 75, cost: 48, weight: "41gm", sku: "CRX-MAS-MOO", reorderLevel: 12, image: "https://i.ibb.co/LXhDLxT1/mast-moongfali.jpg" },
  "Punjabi Tadka": { category: "namkeen", price: 75, cost: 48, weight: "41gm", sku: "CRX-PUN-TAD", reorderLevel: 12, image: "https://i.ibb.co/b5wXL4JX/punjabi-tadka.jpg" },
  "Lite Chivda": { category: "namkeen", price: 75, cost: 48, weight: "39gm", sku: "CRX-LIT-CHI", reorderLevel: 12, image: "https://i.ibb.co/7tTrNbjM/lite-chivda.jpg" }
};
...
const CRAXX_SEED_START = new Date(2025, 0, 1, 10, 0, 0, 0);
let craxxSeedOrdersPromise = null;
const CRAXX_USER_SCOPED_KEYS = new Set([
  "stock", "productCatalog", "customerOrders", "orderHistory", "activityFeed",
  "savedCustomers", "stockHistory", "productHistory", "systemNotifications",
  "craxxIdentity", "adminProfile", "salesTargets", "craxxAnalytics"
]);

function scopedStorageKey(key) {
  if (!CRAXX_USER_SCOPED_KEYS.has(key)) return key;
  let userId = localStorage.getItem("craxxActiveUserId") || "local-admin";
  if (userId === "local-admin") return key;
  return `craxxUser:${userId}:${key}`;
}
...
async function fetchSeedOrders() {
  if (!craxxSeedOrdersPromise) {
    craxxSeedOrdersPromise = fetch("orders.json")
      .then(response => response.ok ? response.json() : {})
      .catch(() => ({}));
  }
  return craxxSeedOrdersPromise;
}
...
function seedOrderRecords(seedOrders, products) {
  ...
  return names.map((customer, index) => {
    // Demo records use fixed historical dates so they never leak into "today".
    let date = new Date(CRAXX_SEED_START);
...
function getSavedOrderRecords(products) {
  ...
  history.forEach((order, index) => {
    if (order && order.id) {
      let created = new Date(order.createdAt || order.timestamp || order.date);
      if (Number.isNaN(created.getTime())) {
        // Preserve legacy records without pretending they happened today.
        created = new Date(2024, 0, 1, 9, 0, index, 0);
        repaired = true;
      }
      byId[order.id] = {
        ...order,
  ...
  let records = Object.values(byId);
  if (repaired) writeJson(CRAXX_ORDER_HISTORY_KEY, records);
  return records;
}
...
function recordOrderSnapshot(customer, items, total) {
  ...
  writeJson(CRAXX_ORDER_HISTORY_KEY, orders);
...
function triggerNotification(type, title, description) {
  ...
  window.dispatchEvent(new CustomEvent("craxx:notifications"));
}

function periodKey(date, mode) {
  let d = new Date(date);
  if (mode === "day") return localDateKey(d);
  if (mode === "month") return `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}`;
  return localDateKey(startOfWeek(d));
}

function summarizeOrders(orders, products, fromDate, toDate) {
...
async function buildCraxxAnalytics() {
  try {
    ...
    let nextWeek = addDays(weekStart, 7);
    let monthStart = startOfMonth(now);
    let nextMonth = new Date(now.getFullYear(), now.getMonth() + 1, 1);

    let todaySummary = summarizeOrders(records, products, today, tomorrow);
    let weeklySummary = summarizeOrders(records, products, weekStart, nextWeek);
    let monthlySummary = summarizeOrders(records, products, monthStart, nextMonth);
    
    let previousWeekStart = addDays(weekStart, -7);
    let previousWeek = summarizeOrders(records, products, previousWeekStart, weekStart);
    let weeklyGrowth = previousWeek.revenue > 0
      ? ((weeklySummary.revenue - previousWeek.revenue) / previousWeek.revenue) * 100
      : (weeklySummary.revenue > 0 ? 100 : 0);
    let previousMonthStart = new Date(now.getFullYear(), now.getMonth() - 1, 1);
    let previousMonth = summarizeOrders(records, products, previousMonthStart, monthStart);
    let monthlyGrowth = previousMonth.revenue > 0
      ? ((monthlySummary.revenue - previousMonth.revenue) / previousMonth.revenue) * 100
      : (monthlySummary.revenue > 0 ? 100 : 0);
    ...
    // Generate labels for the current calendar month.
    let daysInMonth = new Date(now.getFullYear(), now.getMonth() + 1, 0).getDate();
    let dailyLabels = Array.from({ length: daysInMonth }, (_, index) => {
